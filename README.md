...
### Mode
The evaluation method varies depending on the mode.  
The closer you are to the base frame, the higher your score will be.  
However, if you exceed a certain threshold, it will be counted as a miss.  
Basically, “Average” is fine.
- Average (based on 45 frames)
- Fast (based on 42 frames)
- Slow (based on 48 frames)

### Ideal Frames (In Average Mode)
| Input Sequense | Frames |
| --- | --- |
| R1→□ | 21 frames |
| □→R1 | 24 frames |
| □→✕ | 2~3 frames |
